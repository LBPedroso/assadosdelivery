-- ============================================
-- DADOS INICIAIS - ASSADOS DELIVERY
-- Inserção de categorias e produtos do cardápio
-- ============================================
...
-- VERIFICAR INSERÇÕES
-- ============================================
SELECT 'Categorias inseridas:' AS status, COUNT(*) AS total FROM categorias;
SELECT 'Produtos inseridos:' AS status, COUNT(*) AS total FROM produtos;
SELECT 'Usuários admin criados:' AS status, COUNT(*) AS total FROM usuarios_admin;
SELECT 'Clientes de teste criados:' AS status, COUNT(*) AS total FROM clientes;
